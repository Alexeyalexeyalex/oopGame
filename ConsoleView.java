...
public class ConsoleView {
    ...
    public static void view(){
        ...
        for (int i = 1; i <= Main.GANG_SIZE - 1; i++) {
            for (int j = 1; j <= Main.GANG_SIZE; j++) {
                System.out.print(getChar(new Location(j, i)));
            }
            System.out.print("|");
        ...
        for (int j = 1; j <= Main.GANG_SIZE; j++) {
            System.out.print(getChar(new Location(j, Main.GANG_SIZE)));
        }
        System.out.print("|");
        System.out.println(PrintInfo(npcIndex));
        System.out.println(ConsoleView.bottom10);
    }
    private static String getChar(Location position){
    ...
    private static String PrintInfo(int npcIndex)
    {
        ...
        if(Main.darkSide.get(npcIndex).hp == 0)
